...
private val LightColors = lightColorScheme(
    ...
    surfaceContainer = Color(0xFFFBFCFC),
    surfaceContainerHigh = Color(0xFFFBFCFC),
    surfaceContainerHighest = Color(0xFFFBFCFC),
...
private val DarkColors = darkColorScheme(
    ...
    surfaceContainerLow = Color(0xFF101415),
    surfaceContainer = Color(0xFF101415),
    surfaceContainerHigh = Color(0xFF101415),
    surfaceContainerHighest = Color(0xFF101415),
